...
# Team ID value
preview11 <- read.csv('calculate_hhi_11_2015.csv')
preview12 <- read.csv('calculate_hhi_12_2015.csv')
preview13 <- read.csv('calculate_hhi_13_2015.csv')
preview14 <- read.csv('calculate_hhi_14_2015.csv')
preview15 <- read.csv('calculate_hhi_15_2015.csv')
preview16 <- read.csv('calculate_hhi_16_2015.csv')
preview17 <- read.csv('calculate_hhi_17_2015.csv')
preview18 <- read.csv('calculate_hhi_18_2015.csv')
preview19 <- read.csv('calculate_hhi_19_2015.csv')
preview20 <- read.csv('calculate_hhi_20_2015.csv')
preview42 <- read.csv('calculate_hhi_42_2015.csv')
preview43 <- read.csv('calculate_hhi_43_2015.csv')
preview44 <- read.csv('calculate_hhi_44_2015.csv')
preview45 <- read.csv('calculate_hhi_45_2015.csv')
preview340 <- read.csv('calculate_hhi_340_2015.csv')
preview427 <- read.csv('calculate_hhi_427_2015.csv')
preview463 <- read.csv('calculate_hhi_463_2015.csv')
preview479 <- read.csv('calculate_hhi_479_2015.csv')
preview506 <- read.csv('calculate_hhi_506_2015.csv')
preview547 <- read.csv('calculate_hhi_547_2015.csv')
preview <- read.csv('preview_other.csv')
